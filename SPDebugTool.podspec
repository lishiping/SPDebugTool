Pod::Spec.new do |s|
  ...
  s.subspec 'Network' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_NETWORK=1'}
  ...
  s.subspec 'Log' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_LOG=1'}
    ss.dependency                 "SPDebugTool/Storage"
  end
  ...
  s.subspec 'AppInfo' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_APP_INFO=1'}
  ...
  s.subspec 'Sandbox' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_SANDBOX=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'Screenshot' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_SCREENSHOT=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'Hierarchy' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_HIERARCHY=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'Magnifier' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_MAGNIFIER=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'Ruler' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_RULER=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'WidgetBorder' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_WIDGET_BORDER=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'Html' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_HTML=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'Location' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_LOCATION=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
  ...
  s.subspec 'ShortCut' do |ss|
    ...
    ss.pod_target_xcconfig      = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'SPDEBUGTOOL_SHORT_CUT=1'}
    ss.dependency                 "SPDebugTool/Core"
  end
